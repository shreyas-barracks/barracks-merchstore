...
import Barracks_bulb from '../assets/Barracks_Bulb.svg';
    ...
    return (<>
        <div className={`${isHelpModalVisible ? "flex" : "hidden"} fixed z-50 inset-0 bg-black bg-opacity-50 items-center justify-center`}>
            <div className="bg-white p-8 rounded-lg w-96 m-8">
                ...
                <p className="mt-4">For any queries, contact us at <a href="mailto:admin@barracks.army" className="text-blue-500 font-bold">admin@barracks.army</a>
                </p>
            </div>
        </div>
        <div className='select-none p-8 mb-8 rounded-xl shadow-lg text-white w-full h-16 bg-primary flex items-center justify-between'>
            ...
            <a draggable={false} href="https://beta.barracks.army/" target='_blank' className='relative w-[5.4rem] h-24 bg-primary rounded-[50%/40%] justify-center items-center mx-auto hidden sm:flex'>
                <img src={Barracks_bulb} alt="Logo" className="p-2 select-none" draggable={false} />
            </a>
