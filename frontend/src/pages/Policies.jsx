    ...
    const policies = [
        {
            ...
            content: <>
                ...
                <br />
                <p>Our store is managed with great care and attention to detail to provide you with a seamless and enjoyable shopping experience. The website is operated and overseen by <b>Barracks Technologies</b>. Barracks, along with our dedicated team, is committed to upholding the highest standards of quality and service. We strive to ensure that every interaction with our store is smooth, pleasant, and meets your expectations.</p>
                <br />
        ...
        },
        {
            ...
            content: <>
                ...
                <br />
                <p><b>Merchant Legal Entity Name:</b> Barracks Technologies</p>
                <p><b>Telephone No:</b> +91 14426 13413</p>
                <p><b>E-Mail ID:</b> <a href="mailto:admin@barracks.army">admin@barracks.army</a></p>
            </>
        },
        {
            ...
            content: (
                <>
                    <p>These Terms and Conditions, along with privacy policy or other terms (“Terms”) constitute a binding agreement by and between Barracks Technologies, ( “Website Owner” or “we” or “us” or “our”) and you (“you” or “your”) and relate to your use of our website, goods (as applicable) or services (as applicable) (collectively, “Services”).</p>
                    ...
                    <p>All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Ahemdabad.</p>
        ...
        },
        {
            ...
            content: <>
                <p><b><u>Shipping Method:</u></b><br />
                    We offer a convenient collection service for your orders. All products can be picked up from a designated area within the Barracks campus. Once your order is confirmed, you will receive a QR code via email and in your order section on the website. This QR code will be required for collecting your items at the pickup location. Please ensure you have the QR code ready when you arrive. Orders will be delivered within 14 days of confirmation.</p>
        ...
        },
        {
            ...
            content: <>
                ...
                <p>If you have any questions, concerns, or requests regarding this Privacy Policy or how we handle your personal information, please contact us at: <a href="mailto:admin@barracks.army"><b><u>admin@barracks.army</u></b></a></p>
                <br />
